...
class CountryOverview {
    ...
    fill5Items = data => {
        ...
        $("div[data-item-id='11']").empty().html(`<h1>${items(11).value || "N/A"}</h1><p class="mb-0">(${items(11).year || "N/A"})</p><p>${items(11).label || "N/A"}</p>`);
        $("div[data-item-id='12']").empty().html(`<h1>${items(12).value || "N/A"}</h1><p class="mb-0">(${items(12).year || "N/A"})</p><p>${items(12).label || "N/A"}</p>`);
        $("div[data-item-id='13']").empty().html(`<h1>${items(13).value || "N/A"}</h1><p class="mb-0">(${items(13).year || "N/A"}) (${items(13).support_text || "N/A"})</p><p>${items(13).label || "N/A"}</p>`);
        $("div[data-item-id='14']").empty().html(`<h1>${items(14).value || "N/A"}</h1><p class="mb-0">(${items(14).year || "N/A"})</p><p>${items(14).label || "N/A"}</p>`);
    ...
    fill7Items = data => {
        ...
        $("div[data-item-id='31']").empty().html(`<h1>${items(31).value || "N/A"}</h1><p class="mb-0">(${items(31).year || "N/A"})</p><p>${items(31).label || "N/A"}</p>`);
        $("div[data-item-id='32']").empty().html(`<h1>${items(32).value || "N/A"}</h1><p class="mb-0">(${items(32).year || "N/A"})</p><p>${items(32).label || "N/A"}</p>`);
        $("div[data-item-id='33']").empty().html(`<h1>${items(33).value || "N/A"}</h1><p class="mb-0">(${items(33).year || "N/A"}) (${items(33).support_text || "N/A"})</p><p>${items(33).label || "N/A"}</p>`);
        $("div[data-item-id='34']").empty().html(`<h1>${items(34).value || "N/A"}</h1><p class="mb-0">(${items(34).year || "N/A"})</p><p>${items(34).label || "N/A"}</p>`);
    ...
    fill4Items = data => {
        ...
        $("div[data-item-id='51']").empty().html(`<h1>${items(51).value || "N/A"}</h1><p class="mb-0">(${items(51).year || "N/A"})</p><p>${items(51).label || "N/A"}</p>`);
        $("div[data-item-id='52']").empty().html(`<h1>${items(52).value || "N/A"}</h1><p class="mb-0">(${items(52).year || "N/A"})</p><p>${items(52).label || "N/A"}</p>`);
        $("div[data-item-id='53']").empty().html(`<h1>${items(53).value || "N/A"}</h1><p class="mb-0">(${items(53).year || "N/A"}) (${items(53).support_text || "N/A"})</p><p>${items(53).label || "N/A"}</p>`);
        $("div[data-item-id='54']").empty().html(`<h1>${items(54).value || "N/A"}</h1><p class="mb-0">(${items(54).year || "N/A"})</p><p>${items(54).label || "N/A"}</p>`);
    ...
    fill2Items = data => {
        ...
        $("div[data-item-id='71']").empty().html(`<h1>${items(71).value || "N/A"}</h1><p class="mb-0">(${items(71).year || "N/A"})</p><p>${items(71).label || "N/A"}</p>`);
        $("div[data-item-id='72']").empty().html(`<h1>${items(72).value || "N/A"}</h1><p class="mb-0">(${items(72).year || "N/A"})</p><p>${items(72).label || "N/A"}</p>`);
        $("div[data-item-id='73']").empty().html(`<h1>${items(73).value || "N/A"}</h1><p class="mb-0">(${items(73).year || "N/A"}) (${items(73).support_text || "N/A"})</p><p>${items(73).label || "N/A"}</p>`);
        $("div[data-item-id='74']").empty().html(`<h1>${items(74).value || "N/A"}</h1><p class="mb-0">(${items(74).year || "N/A"})</p><p>${items(74).label || "N/A"}</p>`);
