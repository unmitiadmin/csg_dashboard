$(window).on("load", () => {
    ...
    let mitigationCatalog = new Mitigation(countryId);
    mitigationCatalog.init()
});


class Mitigation {
    constructor(countryId) {
        this.categoryId = 2; // only change this for other categories
        this.apiUrl = apiUrl;
                    ...
                    <div class="card tab_card_bg border-0 mb-2">
                        <div class="card-body">
                            <div class="filter-cards">
                                <button class="btn btn-mitigation text-white">Mitigation</button>
                                <p style="min-height:90px;" class="font-14px">${a.project_name.replace(/�/g, "")}</p>
